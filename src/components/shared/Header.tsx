...
import { SearchIcon, Bell, UserCircle, Menu, X } from "lucide-react";
...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white border-b border-thanksgiving-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        {/* Logo */}
        <div className="flex items-center">
          <Link href="/" className="flex items-center">
            <span className="text-thanksgiving-blue font-bold text-xl">
              thanksgiving
            </span>
          </Link>
        </div>
        ...
        <div className="md:hidden bg-white border-t border-thanksgiving-border animate-fade-in-up">
          <div className="px-4 py-3">
            ...
            <div className="flex flex-col space-y-3 py-2">
              <a href="/login" className="text-thanksgiving-blue font-medium">
                Log in
              </a>
              <a href="/signup" className="btn-primary text-center w-full">
                Create account
              </a>
            </div>
          </div>
